...
static void test_shift_operations(void)
{
    ...
    initRegisters();
    int8_t result = execute(8, (int8_t)0x55, 0);  /* 01010101 */
    TEST(result == (int8_t)0xAA, "SLC: 0x55 (01010101) << 1 = 0xAA (10101010)");
    
    initRegisters();
    result = execute(8, (int8_t)0x80, 0);  /* 10000000 */
    TEST(result == 1, "SLC: 0x80 (10000000) << 1 = 0x01 (00000001)");
    
    initRegisters();
    result = execute(8, (int8_t)0xFF, 0);  /* 11111111 */
    TEST(result == (int8_t)0xFF, "SLC: 0xFF (11111111) << 1 = 0xFF (11111111)");
    
    initRegisters();
    result = execute(8, (int8_t)0x01, 0);  /* 00000001 */
    TEST(result == 2, "SLC: 0x01 (00000001) << 1 = 0x02 (00000010)");
    
    initRegisters();
    result = execute(8, (int8_t)0x40, 0);  /* 01000000 */
    TEST(result == (int8_t)0x80, "SLC: 0x40 (01000000) << 1 = 0x80 (10000000)");
    
    /* -------- SRC (Opcode 9): Shift Right Circular -------- */
    printf("\n--- SRC (Opcode 9): Shift Right Circular ---\n");
    
    initRegisters();
    result = execute(9, (int8_t)0xAA, 0);  /* 10101010 */
    TEST(result == (int8_t)0x55, "SRC: 0xAA (10101010) >> 1 = 0x55 (01010101)");
    
    initRegisters();
    result = execute(9, (int8_t)0x01, 0);  /* 00000001 */
    TEST(result == (int8_t)0x80, "SRC: 0x01 (00000001) >> 1 = 0x80 (10000000)");
    
    initRegisters();
    result = execute(9, (int8_t)0xFF, 0);  /* 11111111 */
    TEST(result == (int8_t)0xFF, "SRC: 0xFF (11111111) >> 1 = 0xFF (11111111)");
    
    initRegisters();
    result = execute(9, (int8_t)0x02, 0);  /* 00000010 */
    TEST(result == 1, "SRC: 0x02 (00000010) >> 1 = 0x01 (00000001)");
    
    initRegisters();
    result = execute(9, (int8_t)0x80, 0);  /* 10000000 */
    TEST(result == (int8_t)0x40, "SRC: 0x80 (10000000) >> 1 = 0x40 (01000000)");
}
